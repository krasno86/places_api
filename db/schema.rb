...
ActiveRecord::Schema.define(version: 20_200_407_130_058) do
  ...
  create_table "company_tables", force: :cascade do |t|
    t.integer "company_id"
    t.string "name"
    t.boolean "reservation", default: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["company_id"], name: "index_company_tables_on_company_id"
  end
